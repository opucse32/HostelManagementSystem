...
//colg name
if(isset($_POST['uvnsave']))
{
	$uvname = $_POST['uvname'];
	$query2 = "UPDATE admin SET uvname='$uvname' WHERE id=1";
...
{
	$intro = $_POST['uvintro'];
	$query3 = "UPDATE admin SET uvintro='$intro' WHERE id=1";
...
<table width="1328" height="628" border="1">
  <tbody>
    ...
    <tr>
      ...
      <p><center><b>Change University Name : </b><br>
      ...
      <center><p><b>Change University Intoduction</b><br>
