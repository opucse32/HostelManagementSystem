...
//change colg name
$q2 = "SELECT uvname FROM admin WHERE id=1";
$q21 = mysqli_query($con,$q2);
$uvdisp = mysqli_fetch_array($q21);

//change intro content
$q3 = "SELECT uvintro FROM admin WHERE id=1";
...
<html>
<head>
<title>Metropolitan University Hostel</title>
...
<table width="1050px" align="center"  border="1">
  <tbody>
    <tr>
      <th height="39" colspan="2" style="background-color:#4E4E4E"><div style="text-align:left;color:#FFFFFF"><b><font size="+3"><a href="index.php" style="text-decoration:none ; color:#FFFFFF"><?php echo $uvdisp['colgname'];?></a></font></b><marquee direction="left" height="100%">
...
<li><img src="data1/images/banner_01.jpg" alt="University Of The Third Millennium" title="University Of The Third Millennium" id="wows1_0"/></li>
<li><img src="data1/images/highlightnews.jpg" alt="Large Dyning Space" title="Large Dyning Space" id="wows1_1"/></li>
<li><img src="data1/images/img21644.jpg" alt="Good Weather For Study" title="Good Weather For Study" id="wows1_2"/></li>
<li><img src="data1/images/url.jpg" alt="New Campus Under Construction" title="New Campus Under Construction" id="wows1_3"/></li>
</ul></div>
<div class="ws_bullets"><div>
<a href="#" title="University Of The Third Millennium"><img src="data1/tooltips/banner_01.jpg" alt="University Of The Third Millennium"/>1</a>
<a href="#" title="Large Dyning Space"><img src="data1/tooltips/highlightnews.jpg" alt="ILarge Dyning Space"/>2</a>
<a href="#" title="BGood Weather For Study"><img src="data1/tooltips/img21644.jpg" alt="Good Weather For Study"/>3</a>
<a href="#" title="New Campus Under Construction"><img src="data1/tooltips/url.jpg" alt="New Campus Under Construction"/>4</a>
</div></div>
<span class="wsl"></span>
	...
	?>
	<center>
	  <h2><b><font size="+3"><?php echo $uvdisp['colgname'];?>
	    </font></b></h2>
	</center>
    <center><img src="images/colg.jpg" width="696" height="488"></center>
    <p><center>
      <p>&nbsp;</p>
      <p><strong><font size="+2"><?php echo $uvdisp['uvname'];?></font></strong> <b>-</b> <font size="+1"><?php echo $introdisp['colgintro']; ?></font></p>
    </center></p>
	<?php
    error_reporting(1);
	}
